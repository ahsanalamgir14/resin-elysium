...
@section('content')
    <div class="body-wrapper">
        ...
        <div class="content-wraper pt-60 pb-60 pt-sm-30">
            <div class="container">
                <form id="filterForm" name="filterForm" action="{{ route('product-search') }}" method="POST"
                ...
                <div class="row">
                    <div class="col-lg-9 order-1 order-lg-2">
                        ...
                        <div class="single-banner shop-page-banner">
                            <a href="#">
                                <img src="{{ asset('storage/images/bg-banner/2.jpg') }}" alt="Li's Static Banner">
                            </a>
                        </div>
                        ...
                        <div class="shop-top-bar mt-30">
                            ...
                            <div class="product-select-box">
                                <div class="product-short">
                                    <p>Sort By:</p>
                                    <select form="filterForm" class="nice-select" id="sort_by_filter" name="sort"
                                        value="" onchange="applyFilter()">
                                                            ...
                                                            <div class="product_desc_info">
                                                                <div class="product-review">
                                                                    <h5 class="manufacturer">
                                                                        <a
                                                                            href="/categories/{{ $product->category->name }}">{{ $product->category->name }}</a>
                                                                    </h5>
                    ...
                    <div class="col-lg-3 order-2 order-lg-1">
                        ...
                        <div class="sidebar-categores-box">
                            ...
                            <!-- btn-clear-all start -->
                            <button class="btn-clear-all mb-sm-30 mb-xs-30" onclick=clearFilters()>Clear all</button>
                            <!-- btn-clear-all end -->
                            ...
                            <div class="filter-sub-area pt-sm-10 pt-xs-10">
                                ...
                                <div class="categori-checkbox">
                                    {{-- <form id='catCheckFilters'> --}}
                                    <ul>
                                        @foreach ($categories as $key => $category)
                                            <li><input form="filterForm" type="checkbox" name="filter_categories[]"
                                                    value="{{ $category->id }}"
                                                    @if ($filter_categories) @if (in_array($category->id, $filter_categories)) checked @endif
                                                    @endif
                                                >
