        ...
        <div class="row">
            <div class="col-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form action="/admin/manage-products/{{$id}}" method="post" enctype='multipart/form-data'>
                            @csrf
                            @method('PUT')
                            <div class="">
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input id="main_image" value="{{$main_image}}" name="main_image" type="file" class="form-control">
                                            @error('main_image')
                                            <span class="invalid-feedback d-inline" role="alert">
                                                <strong>{{ $message }}</strong>
                                            </span>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6 form-group">
                                        ...
                                        <input id="slug" value="{{$slug}}" name="slug" type="text" class="form-control" value="">
                                        @error('slug')
                                        <span class="invalid-feedback d-inline" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
                                ...
                                <div class="row">
                                    <div class="col-md-6 form-group">
                                        ...
                                        <input id="type" value="{{$type}}" name="type" type="text" class="form-control" value="">
                                        @error('type')
                                        <span class="invalid-feedback d-inline" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
                                    ...
                                    <div class="col-md-6 form-group">
                                        ...
                                        <input id="SKU" value="{{$SKU}}" name="SKU" type="text" class="form-control">
                                        @error('SKU')
                                        <span class="invalid-feedback d-inline" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
                                ...
                                <div class="row">
                                    <div class="col-md-6 form-group">
                                        ...
                                        <input id="price" value="{{$price}}" name="price" type="text" class="form-control" value="">
                                        @error('price')
                                        <span class="invalid-feedback d-inline" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
                                    ...
                                    <div class="col-md-6 form-group">
                                        ...
                                        <input id="qty" value="{{$qty}}" name="qty" type="text" class="form-control" value="">
                                        @error('qty')
                                        <span class="invalid-feedback d-inline" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
